...
class Aplicacion(tk.Tk):
    ...
    def crear_widgets(self):
        ...
        self.grid = tk.LabelFrame(self, text=".: Datos Obtenidos Para Inventario :.", labelanchor="n") #Labelanchor n para centrar texto North se usa NSWE norte sur este oeste
